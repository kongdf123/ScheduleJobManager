...
namespace JobMonitor.Desktop.UI.UserControls
{
    ...
    /// </summary>
    public class EventConfigDataGridViewActionButtonColumn : DataGridViewColumn
    {
        public EventConfigDataGridViewActionButtonColumn()
        {
            this.CellTemplate = new EventConfigDataGridViewActionButtonCell();
            this.HeaderText = "操作";
        }
    }
    ...
    /// </summary>
    public class EventConfigDataGridViewActionButtonCell : DataGridViewButtonCell
    {
        ...
        public static bool IsModifyButtonClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (sender is DataGridView)
            {
                ...
                if (DgvGrid.Columns[e.ColumnIndex] is EventConfigDataGridViewActionButtonColumn)
                {

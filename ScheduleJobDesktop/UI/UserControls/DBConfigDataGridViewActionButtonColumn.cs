...
namespace JobMonitor.Desktop.UI.UserControls
{
    ...
    /// </summary>
    public class DBConfigDataGridViewActionButtonColumn : DataGridViewColumn
    {
        public DBConfigDataGridViewActionButtonColumn()
        {
            this.CellTemplate = new DBConfigDataGridViewActionButtonCell();
            this.HeaderText = "操作";
        }
    }
    ...
    /// </summary>
    public class DBConfigDataGridViewActionButtonCell : DataGridViewButtonCell
    {
        ...
        public static bool IsModifyButtonClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (sender is DataGridView)
            {
                ...
                if (DgvGrid.Columns[e.ColumnIndex] is DBConfigDataGridViewActionButtonColumn)
                {
